...
public class PetResourceTest extends JerseyTest {
	...
	public void testList() throws IOException {
		final Response response = target("pet").request()
		...
		assertThat(pet, containsPetInAnyOrder(pet()));
	}
	...
	public void testGet() throws IOException {
		final Response response = target("pet/" + existentId()).request()
			.header("Authorization", "Basic " + userToken(adminLogin()))
		.get();
		assertThat(response, hasOkStatus());
	...
	public void testGetInvalidId() throws IOException {
		final Response response = target("pet/" + nonExistentId()).request()
			.header("Authorization", "Basic " + userToken(adminLogin()))
		.get();
	...
	public void testAdd() throws IOException {
		...
		final Response response = target("pet").request(MediaType.APPLICATION_JSON_TYPE)
			.header("Authorization", "Basic " + userToken(adminLogin()))
	...
	public void testModify() throws IOException {
		...
		final Response response = target("pet/" + existentId()).request(MediaType.APPLICATION_JSON_TYPE)
			.header("Authorization", "Basic " + userToken(adminLogin()))
	...
	public void testModifyInvalidId() throws IOException {
		...
		final Response response = target("pet/" + nonExistentId()).request(MediaType.APPLICATION_JSON_TYPE)
			.header("Authorization", "Basic " + userToken(adminLogin()))
